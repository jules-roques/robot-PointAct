...
# login node with `wandb sync` (WANDB_MODE / WANDB_DIR are set by train.slurm). Set
# WANDB_ENTITY to your own team/user, or export WANDB_MODE=disabled to skip logging.
